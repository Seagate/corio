...
#
"""S3 Object test scenario for io stability."""
...
class S3ObjectTestCase(unittest.TestCase):
    ...
    def test_checksum_part_file_positive_less_1mib(self, mock_getsize):
        ...
        expected_logs = [
            f'INFO:src.libs.s3api.s3_object_ops:Reading size is {KIB}',
            f'DEBUG:src.libs.s3api.s3_object_ops:Reading {KIB} from starting offset {offset}']
