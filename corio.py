...
function_mapping = {
    ...
    'multipart': [test_s3_multipart_io_stability.TestMultiParts,
...
def parse_args():
    ...
    parser.add_argument("-us", "--use_ssl",
...
async def create_session(funct: list, session: str, start_time: float,
                         **kwargs) -> None:
    """
